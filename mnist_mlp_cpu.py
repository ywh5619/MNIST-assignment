...
class MNIST_MLP(object):
    def __init__(self, batch_size=30, input_size=784, hidden1=256, hidden2=128, hidden3=64, out_classes=10, lr=0.01, max_epoch=4, print_iter=100):
    ...
    def load_data(self):
        # Call the function load_mnist to read and preprocess the images and labels of the training and test data in MNIST
    ...
    def build_model(self):
        # Build a three-layer neural network structure
        ...
        self.fc4 = FullyConnectedLayer(self.hidden2, self.out_classes)
        self.softmax = SoftmaxLossLayer()
        self.update_layer_list = [self.fc1
                                , self.fc2
                                # , self.fc3
                                , self.fc4
                                  ]
